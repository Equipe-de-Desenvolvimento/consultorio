        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <a class="btn btn-outline btn-danger" href="<?php echo base_url() ?>ambulatorio/modelodeclaracao/carregarmodelodeclaracao/0">
                                    ...
                                    foreach ($lista as $item) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="tabela_acoes" width="100px;">
                                                ...
                                                <a class="btn btn-outline btn-primary btn-sm" href="<?= base_url() ?>ambulatorio/modelodeclaracao/carregarmodelodeclaracao/<?= $item->ambulatorio_modelo_declaracao_id ?>">
                                                    Editar
                                                </a>
                                            </td>
                                        </tr>
