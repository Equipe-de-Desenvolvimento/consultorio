        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <a class="btn btn-outline btn-danger" href="<?php echo base_url() ?>ambulatorio/agenda/carregar/0">
                        <i class="fa fa-plus fa-w"></i> Novo Horário
                    </a>
                    <div class="table-responsive" id="pesquisar">
                                    ...
                                    foreach ($lista as $item) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="tabela_acoes" style="width: 200pt;">
                                                <p>
                                                    <a class="btn btn-danger btn-outline btn-sm" onclick="confirmacaoexcluir(<?= $item->agenda_id; ?>);">
                                                    Excluir
                                                </a>
                                            
                                                <a class="btn btn-outline btn-primary  btn-sm" href="<?= base_url() ?>ambulatorio/agenda/carregar/<?= $item->agenda_id ?>" target="_self">
                                                    Detalhes
                                                </a>
