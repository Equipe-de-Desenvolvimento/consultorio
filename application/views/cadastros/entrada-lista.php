        ...
        <div class="col-lg-12">
            ...
            <!--                                <input type="text"  id="datafim" alt="date" name="datafim" class="size1"  value="<?php echo @date('t/m/Y'); ?>" /> -->
                ...
                <div class="panel-body">
                    <a class="btn btn-outline btn-danger" href="<?php echo base_url() ?>cadastros/caixa/novaentrada/0">
                        <i class="fa fa-plus fa-w"></i> Nova Entrada
                    </a>
                    <div class="table-responsive" id="pesquisar">
                                ...
                                foreach ($lista as $item) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="tabela_acoes">
                                            <a class="btn btn-outline btn-info btn-sm" href="<?= base_url() ?>cadastros/caixa/anexarimagementrada/<?= $item->entradas_id ?>">Arquivos</a>
                                            <a class="btn btn-outline btn-danger btn-sm" onclick="confirmacaoexcluir(<?= $item->entradas_id ?>);" >Excluir</a>
...
<script type="text/javascript">
                                        ...
                                        function confirmacaoexcluir(idexcluir) {
                                            swal({
                                                title: "Tem certeza?",
                                                text: "Você está prestes a excluir uma entrada!",
                                                type: "warning",
                                                ...
                                                closeOnCancel: false
                                                    ...
                                                    function (isConfirm) {
                                                        if (isConfirm) {
                                                            window.open('<?= base_url() ?>cadastros/caixa/excluirentrada/' + idexcluir, '_self');
                                                        } else {
                                                            swal("Cancelado", "Você desistiu de excluir uma entrada", "error");
                                                        }
                                                    });
