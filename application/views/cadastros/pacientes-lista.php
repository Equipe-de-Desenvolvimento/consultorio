...
<!--            <a class="btn btn-outline btn-info" href="<?php echo base_url() ?>cadastros/pacientes/novo">
            ...
            <div class="panel panel-default">
                ...
                <div class="table-responsive" id="pesquisar">
                    <form method="get" action="<?php echo base_url() ?>cadastros/pacientes/pesquisar">
                        <table width="100%" class="table " id="dataTables-example">
                            ...
                            <tr class="">
                                <td><input type="text" name="prontuario" class="form-control" value="<?php echo @$_GET['prontuario']; ?>" /></td>
                ...
                <div class="panel-body">
                    <a class="btn btn-outline btn-danger" href="<?php echo base_url() ?>cadastros/pacientes/novo">
                                    ...
                                    foreach ($lista as $item) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 110pt;" class="tabela_acoes">
                                                <a class="btn btn-outline btn-primary btn-sm" href="<?= base_url() ?>cadastros/pacientes/carregar/<?= $item->paciente_id ?>">
                                                    Editar
                                                </a> 
