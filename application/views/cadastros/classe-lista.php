        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <a class="btn btn-outline btn-danger" href="<?php echo base_url() ?>cadastros/classe/carregarclasse/0">
                        <i class="fa fa-plus fa-w"></i> Novo Classe
                    </a>
                    <div class="table-responsive" id="pesquisar">
                                ...
                                foreach ($lista as $item) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="tabela_acoes" >                                  
                                            <a  class="btn btn-outline btn-primary btn-sm" href="<?= base_url() ?>cadastros/classe/carregarclasse/<?= $item->financeiro_classe_id ?>">Editar</a>

                                            <a  class="btn btn-outline btn-danger btn-sm" onclick="confirmacaoexcluir(<?= $item->financeiro_classe_id ?>);">Excluir</a>
                                        </td>
                                    </tr>
...
<script type="text/javascript">
    ...
    function confirmacaoexcluir(idexcluir) {
        swal({
            title: "Tem certeza?",
            text: "Você está prestes a deletar uma classe!",
            type: "warning",
            ...
            closeOnCancel: false
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        window.open('<?= base_url() ?>cadastros/classe/excluir/' + idexcluir, '_self');
                    } else {
                        swal("Cancelado", "Você desistiu de excluir uma classe", "error");
                    }
                });
